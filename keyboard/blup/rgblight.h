...
#define RGBLIGHT_EFFECT_MAX_WAVES 4
#endif

#ifndef RGBLIGHT_EFFECT_RAINDROP_LENGTH
#define RGBLIGHT_EFFECT_RAINDROP_LENGTH 3
#endif

#ifndef RGBLIGHT_EFFECT_HORSE_LENGTH
#define RGBLIGHT_EFFECT_HORSE_LENGTH 3
#endif
...
#define RGBLIGHT_EFFECT_KNIGHT_OFFSET MATRIX_COLS
#endif
...
void rgblight_effect_battery(uint16_t voltage);
