...
#define rgblight_timer_init() do { DDRD |= (1<<PD1);} while(0)
#define rgblight_timer_enable() do { PORTD &= ~(1<<PD1);} while(0)
#define rgblight_timer_disable() do { PORTD |= (1<<PD1);} while(0)
#define rgblight_timer_enabled !(PORTD&(1<<PD1))
