...
#define rgblight_timer_init() do { DDRD |= (1<<PD4);} while(0)
#define rgblight_timer_enable() do { PORTD &= ~(1<<PD4);} while(0)
#define rgblight_timer_disable() do { PORTD |= (1<<PD4);} while(0)
