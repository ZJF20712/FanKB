 ...
 * pin: F7  C7  C6  B6  B5  B4  D7  D6  D4  D5  D3  D2  F6  B7  E6
 */
static void  init_cols(void)
{
...
{
        switch (col) {
            case 0: return PINF&(1<<PF7) ? 0 : 1;
            case 1: return PINC&(1<<PC7) ? 0 : 1;
            case 2: return PINC&(1<<PC6) ? 0 : 1;
            case 3: return PINB&(1<<PB6) ? 0 : 1;
            case 4: return PINB&(1<<PB5) ? 0 : 1;
            case 5: return PINB&(1<<PB4) ? 0 : 1;
            case 6: return PIND&(1<<PD7) ? 0 : 1;
            case 7: return PIND&(1<<PD6) ? 0 : 1;
            case 8: return PIND&(1<<PD4) ? 0 : 1;
            case 9: return PIND&(1<<PD5) ? 0 : 1;
            case 10: return PIND&(1<<PD3) ? 0 : 1;
            case 11: return PIND&(1<<PD2) ? 0 : 1;
            case 12: return PINF&(1<<PF6) ? 0 : 1;
            case 13: return PINB&(1<<PB7) ? 0 : 1;
