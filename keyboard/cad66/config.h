...
#define PRODUCT_ID      0x8066
#define DEVICE_VER      0x0001
#define MANUFACTURER    YANG
#define PRODUCT        CAD66 Keyboard
#define DESCRIPTION     t.m.k. keyboard firmware for CAD66
...
#define SLED_NUM 71 //Number of switch led
